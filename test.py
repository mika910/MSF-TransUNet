...
from networks.MSF_TransUNet import VisionTransformer as ViT_seg
from networks.MSF_TransUNet import CONFIGS as CONFIGS_ViT_seg
...
parser.add_argument('--max_epochs', type=int, default=150, help='maximum epoch number to train')  # 30
...
parser.add_argument('--vit_name', type=str, default='R50-ViT-B_16', help='select one vit model')  # ViT-B_16
...
if __name__ == "__main__":
    ...
    snapshot_path = snapshot_path + '_' + str(args.img_size) + str('/')
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, args.exp, "MSF-Transunet")
